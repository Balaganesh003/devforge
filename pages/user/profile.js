    ...
    <div className="block  mobile-lg:max-w-[64rem] w-full    px-2 mobile-md:px-4 mobile-lg:px-6 md:px-8 py-8 mt-[10rem] mx-auto ">
      <div className="flex flex-col gap-6 ">
        <div className=" flex flex-row gap-6">
          {/* Profile header */}
          <div className="w-full basis-[70%] bg-white rounded-[10px] p-6 flex gap-6  border border-[#d7d7d7] relative">
            <div className="w-[6rem] h-[6rem] bg-gray-400 border border-[#d7d7d7] rounded-[10px]"></div>
            <div className="">
          ...
          <div className="w-full basis-[30%] p-6 border rounded-[10px] border-[#d7d7d7]  flex items-center justify-center bg-white">
            <div className="flex flex-col w-full items-center justify-center">
              <Image src={LogoRank} alt="rank" width={84} height={84} />
              <p className="text-[#3870DD] text-[1rem]">Rank yet to achive</p>
            </div>
          </div>
        </div>
        <div className=" flex flex-row gap-6">
          <div className="w-full basis-[70%] flex gap-6 ">
            {/* Social links */}
            <div className=" basis-[45%] p-6 bg-white border rounded-[10px] border-[#d7d7d7] relative">
            ...
            <div className=" basis-[55%] p-6 bg-white border rounded-[10px] items-center flex gap-6 border-[#d7d7d7]">
          ...
          <div className="basis-[30%] bg-white w-full p-6 border rounded-[10px] border-[#d7d7d7]">
            <div className="flex flex-col w-full items-center justify-center">
      ...
      <div className="p-[3rem] bg-white border border-[#d7d7d7] rounded-[10px] mt-6 flex items-end justify-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-center text-[0.875rem] mt-5 max-w-[64ch] leading-[1.5rem] text-[#666C7E]">
            ...
            and work you delivered. Let your participation in virtual internship
            challenges/hackathons/ competitions showcase your skills and
            accomplishments
          </p>
        </div>
      </div>
