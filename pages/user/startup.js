  ...
  return (
    <div>
      ...
      <div className="block  mobile-lg:max-w-[64rem] w-full    px-2 mobile-md:px-4 mobile-lg:px-6 md:px-8  my-[3.5rem] mx-auto ">
        <div className="w-full flex  flex-col md:flex-row gap-6 font-CabinetGrotesk-Medium">
          ...
          <div className="basis-[75%] border bg-white border-[#d7d7d7] rounded-[10px] p-6 flex-1">
            ...
            <p className="font-sans text-[1rem]">
              As a platform aimed at redefining the way, students learn new
              skills and upskill with work experience we intend to provide
              complete transparency by matching students with startups based on
              their interest, problem solving skills and creativity approach
              towards an idea.
            </p>
        ...
        <div className="w-full   border border-[#d7d7d7] bg-white rounded-[10px] p-10 mt-6">
          <div className="w-full flex items-center justify-center flex-col">
            ...
            <p className="mt-4 pb-2 text-[1rem] text-center">
              You don&lsquo;t have any invites yet as you haven&lsquo;t
        ...
        <div className="w-full  bg-white flex gap-6  border border-[#d7d7d7] rounded-[10px] px-6 items-center py-4 mt-6">
