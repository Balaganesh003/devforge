  ...
  return (
    <div>
      ...
      <div
        ...
        <div className="grid max-w-[313px] mx-auto  grid-cols-1 mobile-xl:grid-cols-2 md:grid-cols-3 md:grid-rows-3 gap-6  mt-[3.5rem] mobile-xl:max-w-[650px] md:max-w-none pb-[3rem] w-full">
