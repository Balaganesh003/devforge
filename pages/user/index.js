...
export default function User() {
  return (
    <div
      className={`${inter.className} block w-full  mobile-lg:max-w-[64rem]    px-2 mobile-md:px-4 mobile-lg:px-6 md:px-8 mx-auto`}>
      <div className="grid max-w-[313px] mx-auto  grid-cols-1 mobile-lg:grid-cols-2 md:grid-cols-3 md:grid-rows-3 gap-6  mt-[6.4rem] mobile-lg:max-w-[650px] md:max-w-none pb-5 w-full">
        <div className="grid w-full col-span-1  grid-rows-3 row-span-3 gap-6">
          <div className=" col-span-1 row-span-2">
            ...
            <div className="flex bg-white flex-col rounded-[10px] overflow-hidden border border-[#d7d7d7] min-h-[24rem] w-full h-full">
              ...
              <div className="basis-[58%] bg-white p-6 pt-[3.5rem] flex flex-col justify-between">
                <p className="text-[1rem] leading-[1.75rem] tracking-[-0.02rem] ">
          ...
          <div className="p-6 min-h-[11.25rem] rounded-md col-span-1 row-span-1 border border-[#d7d7d7] bg-red-200">
            <p className="text-[1rem] h-full leading-[1.5rem] tracking-[-0.015rem] p-4 bg-white rounded-md flex items-center justify-center">
              <span>
        ...
        <div className="col-span-1  mx-auto row-span-3 min-h-[35rem] ">
          {/* 3rd element */}
        ...
        <div className="grid mobile-lg:col-span-2 mobile-lg:grid-cols-2 md:col-span-1 md:grid-cols-1 md:grid-rows-2 md:row-span-3 gap-6  ">
          <div className="bg-[#DBE6EC] col-span-1 row-span-1 p-6 rounded-lg text-[#00679D] border boder-[#d7d7d7] ">
            <div className="bg-white w-full h-full rounded-lg text-[1.8rem] p-6 flex justify-center items-center ">
          ...
          <div className="bg-white col-span-1 row-span-1 p-6 rounded-lg border  border-[#d7d7d7]">
            <div className="bg-[#F1FBF9] text-[#014552] p-4 rounded-md text-[1.8rem]">
              1st September
            </div>
            <div className="text-[1rem] pt-6 leading-[2rem]">
